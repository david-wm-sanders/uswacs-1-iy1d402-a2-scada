...
\begin{todoenv}
  ...
  \begin{enumerate}[label=(\alph*)]
    \item talk about Thales
    \item talk about Project IndiCon
    \item mention the scenario
    \item talk about the project phases
  \end{enumerate}
\end{todoenv}

\pagebreak
\section{SCADA Overview}
\todo{detail what SCADA is in brief here}

\pagebreak
\section{Typical SCADA Architectures for CNI}
\begin{todoenv}
  \begin{enumerate}[label=(\alph*)]
    \item what are the building blocks --- Control Systems, GUIs, PLCs, RTUs, Communications infrastructure, etc.
    \item concept of operations - how the systems work (together...)
    \item industrial, distributed control systems!
  \end{enumerate}
\end{todoenv}

\pagebreak
\section{SCADA and Industrial IoT}
\begin{todoenv}
  \begin{enumerate}[label=(\alph*)]
